...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1 style="color: red; font-weight: bold">Manage Category</h1>
            <br />
            <a style="padding: 5px 20px" class="btn btn-success" href="./add_category.jsp?admin_id=<%=admin_id%>"
               >Add Category</a
            >
            <br />
            <br />
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="./update_category.jsp?category_id=<%=rs.getString(1)%>&admin_id=<%=admin_id%>"
                               ><i class="fa fa-edit" aria-hidden="true"></i
                                ></a>
                            &nbsp;
                            <a href="./delete_category.jsp?category_id=<%=rs.getString(1)%>&admin_id=<%=admin_id%>"
                               ><i
                                    style="color: red"
