...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1 style="color: red; font-weight: bold">Manage Director</h1>
            <br />
            <a style="padding: 5px 20px" class="btn btn-success" href="./add_director.jsp?admin_id=<%=admin_id%>"
               >Add Director</a
            >
            <br />
            <br />
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <%
                        ...
                        PreparedStatement pst = con.prepareStatement("select * from director");
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="./update_director.jsp?director_id=<%=rs.getString(1)%>&admin_id=<%=admin_id%>"
                               ><i class="fa fa-edit" aria-hidden="true"></i
                                ></a>
                            &nbsp;
                            <a href="./delete_director.jsp?director_id=<%=rs.getString(1)%>&admin_id=<%=admin_id%>"
                               ><i
                                    style="color: red"
